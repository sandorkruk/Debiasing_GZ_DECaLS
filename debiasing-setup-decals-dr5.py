...
input_votefrac_cat = f'{outdir}/current_final_dr5_result_extra_n30.fits'
input_extraval_cat = f'{outdir}/current_final_dr5_result_extra_n30.fits'
output_cat = f'{outdir}/current_final_dr5_result_debiased.fits.gz'
